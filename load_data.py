...
def get_all_files(file_path, is_random=True):
    ...
    for item in files:
        ...
        if os.path.isfile(item_path):
            ...
            raise ValueError('there is none_file')
        ...
        if item_label == 'cat':  # 猫标记为'0'
            ...
            label_list.append(1)
            dog_count += 1
    print('there is %d cats,%d dogs.' % (cat_count, dog_count))
...
def get_batch(train_list, image_size, batch_size, capacity, is_random=False):
